...
function PickUpdatesComponent({
  ...
  if (state === STATES.init) {
    ...
    return _react.default.createElement(_ink.Text, null, _react.default.createElement(_ink.Color, {
      green: true
    }, _react.default.createElement(_inkSpinner.default, null)), " checking dependency updates");
    ...
    return _react.default.createElement(_ink.Text, null, _react.default.createElement(_ink.Color, {
      green: true
    }, _react.default.createElement(_inkSpinner.default, null)), " installing updated deps");
  } else if (state === STATES.updated) {
    setImmediate(onDone);
    return _react.default.createElement(_ink.Text, null, "updated ", updated.length, " deps");
  } else {
    return _react.default.createElement(_ink.Text, null, "...");
  }
}