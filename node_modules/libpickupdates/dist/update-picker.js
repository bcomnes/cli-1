...
const types = ['dependency', 'optionalDependency', 'devDependency'];
...
function Outdated({
  ...
  return _react.default.createElement(_ink.Text, null, name, type && _react.default.createElement(_ink.Color, {
    green: true
